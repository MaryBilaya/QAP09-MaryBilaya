...
class MyCounter:
    ...
    # 5. Сравнить количество уникальных букв в каждом файле и вывести на экран в каком файле больше всего
...
print(f"The sum of all punctuation symbols is:", counter_7.count_punctuation_symbols +
                                                 counter_8.count_punctuation_symbols +
                                                 counter_9.count_punctuation_symbols)
print()
